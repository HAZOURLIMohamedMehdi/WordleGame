...
public class Main extends Application {
	...
	public void start(Stage arg0) throws Exception {
		...
		initialpage.interactionPageSalonPage(arg0, sc);
		...
		arg0.show();
		/*
		 * Scene sc = new Scene(new SalonCreer(),750,700);
		 * sc.getStylesheets().add(getClass().getResource("application.css").
		 * toExternalForm()); arg0.setScene(sc); arg0.setMinWidth(750);
		 * arg0.setMinHeight(650); arg0.setTitle("WORDLE"); arg0.show();
		 */
	}
